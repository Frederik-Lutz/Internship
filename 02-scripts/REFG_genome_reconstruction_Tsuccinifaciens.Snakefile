...
# Step: Reconstruction of T. succinifaciens
#
# Dependent on:
#   - PREP_remove_hostDNA.Snakefile
#
# Alex Huebner, 28/04/23
################################################################################
...
rule samtools_calmd:
    ...
    output:
        "04-analysis/refgenome_reconst_tsuccinifaciens/{sample}.calmd.bam"
...
rule samtools_index:
    input:
        "04-analysis/refgenome_reconst_tsuccinifaciens/{sample}.calmd.bam"
    output:
        "04-analysis/refgenome_reconst_tsuccinifaciens/{sample}.calmd.bam.bai"
...
rule bcftools_consensus:
    ...
    resources:
        ...
        cores = 2
    params:
        fasta = "tmp/genome_reconst_tsuccinifaciens/Tsuccinifaciens.fna.gz"
    threads: 2
    shell:
        """
